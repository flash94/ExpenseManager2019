package com.hayroyal.assignment.expensemanager3.db;
...
public class ExpenseDbHelper extends SQLiteOpenHelper {
    ...
    private static final class CategoriesTable {
        ...
        public static void fillTable(SQLiteDatabase db, Context ctx) {
            String[] predefinedNames = ctx.getResources().getStringArray(com.hayroyal.assignment.expensemanager3.R.array.predefined_categories);
