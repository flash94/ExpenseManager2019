package com.hayroyal.assignment.expensemanager3.adapters;
...
import com.hayroyal.assignment.expensemanager3.providers.ExpensesContract;
...
public class SectionExpenseAdapter extends SectionCursorAdapter {
    ...
    protected View newSectionView(Context context, Object item, ViewGroup parent) {
        return getLayoutInflater().inflate(com.hayroyal.assignment.expensemanager3.R.layout.expense_report_section_header, parent, false);
    }
    ...
    protected View newItemView(Context context, Cursor cursor, ViewGroup parent) {
        return getLayoutInflater().inflate(com.hayroyal.assignment.expensemanager3.R.layout.expense_list_item, parent, false);
    }

    @Override
    protected void bindItemView(View convertView, Context context, Cursor cursor) {
        // Find fields to populate in inflated template
        TextView tvExpenseValue = (TextView) convertView.findViewById(com.hayroyal.assignment.expensemanager3.R.id.expense_value_text_view);
        TextView tvExpenseCurrency = (TextView) convertView.findViewById(com.hayroyal.assignment.expensemanager3.R.id.expense_currency_text_view);
        TextView tvExpenseCatName = (TextView) convertView.findViewById(com.hayroyal.assignment.expensemanager3.R.id.expense_category_name_text_view);
